          ...
          >
            ...
            <DropdownMenuSub>
              ...
              <DropdownMenuSubContent className="w-48">
                <DropdownMenuItem>Документация API</DropdownMenuItem>
                <DropdownMenuItem>Репозиторий</DropdownMenuItem>
                <DropdownMenuItem>Тестирование</DropdownMenuItem>
              </DropdownMenuSubContent>
            </DropdownMenuSub>
